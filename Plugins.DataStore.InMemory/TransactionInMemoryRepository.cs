...
namespace Plugins.DataStore.InMemory
{
    public class TransactionInMemoryRepository : ITransactionRepository
    {
        ...
        public IEnumerable<Transaction> Get(string cahierName)
        {
            if (string.IsNullOrWhiteSpace(cahierName))
                return transactions;
            else
                return transactions.Where(x => string.Equals(x.CashierName, cahierName, StringComparison.OrdinalIgnoreCase));
        }
